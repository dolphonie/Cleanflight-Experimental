...
int blackboxPrintf(const char *fmt, ...)
{
    ...
    int written = tfp_format(((void *)0), _putc, fmt, va);
    __builtin_va_end(va);
    return written;
}
...
# 198 "./src/main/blackbox/blackbox_io.c"
...
_Bool blackboxDeviceOpen(void)
{
    ...
    blackboxWriteChunkSize = (((masterConfig.looptime * 9) / 1250) > (4) ? ((masterConfig.looptime * 9) / 1250) : (4));
