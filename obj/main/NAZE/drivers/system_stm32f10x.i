...
void systemReset(void)
{
    ...
    *((uint16_t *)(((uint32_t)0x40000000) + 0x6C00) + 0x04) = (0x50F7B007) & 0xffff;
    *((uint16_t *)(((uint32_t)0x40000000) + 0x6C00) + 0x08) = ((0x50F7B007) & 0xffff0000) >> 16;
...
_Bool isMPUSoftReset(void)
{
    if ((*((uint16_t *)(((uint32_t)0x40000000) + 0x6C00) + 0x04) | *((uint16_t *)(((uint32_t)0x40000000) + 0x6C00) + 0x08) << 16) == (0x50F7B007))
        return 1;
    else
        return 0;
}
