...
static void ECHO_EXTI_IRQHandler(void)
{
    ...
    if (digitalIn(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), sonarHardware->echo_pin) != 0) {
        timing_start = micros();
    } else {
        timing_stop = micros();
...
# 96 "./src/main/drivers/sonar_hcsr04.c"
...
void hcsr04_start_reading(void)
{
    ...
    digitalHi(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), sonarHardware->trigger_pin);

    delayMicroseconds(11);
    digitalLo(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), sonarHardware->trigger_pin);
}
