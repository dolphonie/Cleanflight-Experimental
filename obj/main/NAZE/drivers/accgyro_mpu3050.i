...
# 29 "./src/main/drivers/accgyro_mpu3050.c" 2
...
static uint8_t mpuLowPassFilter = 0x03;
...
_Bool mpu3050Detect(gyro_t *gyro, uint16_t lpf)
{
    ...
    switch (lpf) {
        case 256:
            ...
            break;
        case 188:
            mpuLowPassFilter = 0x01;
            break;
        case 98:
            mpuLowPassFilter = 0x02;
            break;
        default:
        case 42:
            mpuLowPassFilter = 0x03;
            break;
        case 20:
            mpuLowPassFilter = 0x04;
            break;
        case 10:
            mpuLowPassFilter = 0x05;
            break;
    }
...
static void mpu3050Init(void)
{
    ...
    i2cWrite(0x68, 0x16, 0x18 | mpuLowPassFilter);
    i2cWrite(0x68, 0x17, 0);
    i2cWrite(0x68, 0x3D, 0x01);
    i2cWrite(0x68, 0x3E, 0x01);
}
