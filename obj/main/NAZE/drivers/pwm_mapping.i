...
# 361 "./src/main/drivers/pwm_mapping.c"
...
# 401 "./src/main/drivers/pwm_mapping.c"
        if (init->useUART2 && (timerIndex == PWM3 || timerIndex == PWM4))
            continue;
# 412 "./src/main/drivers/pwm_mapping.c"
...
# 499 "./src/main/drivers/pwm_mapping.c"
        }
...
# 529 "./src/main/drivers/pwm_mapping.c"
        if (type == MAP_TO_PPM_INPUT) {
# 540 "./src/main/drivers/pwm_mapping.c"
