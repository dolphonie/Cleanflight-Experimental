...
# 32 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
static _Bool mpu6500Detect(void)
{
    uint8_t tmp;

    mpu6500ReadRegister((0x75), &tmp, 1);
    if (tmp != (0x70))
        return 0;
...
static void mpu6500AccRead(int16_t *accData)
{
    ...
    mpu6500ReadRegister((0x3B), buf, 6);
...
static void mpu6500GyroInit(void)
{
    ...
    mpu6500WriteRegister((0x6B), (0x80));
    delay(100);
    mpu6500WriteRegister((0x6B), 0);
    delay(100);
    mpu6500WriteRegister((0x6B), INV_CLK_PLL);
    mpu6500WriteRegister((0x1B), INV_FSR_2000DPS << 3);
    mpu6500WriteRegister((0x1C), INV_FSR_8G << 3);
    mpu6500WriteRegister((0x1A), mpuLowPassFilter);
    mpu6500WriteRegister((0x19), 0);
}
...
static void mpu6500GyroRead(int16_t *gyroADC)
{
    ...
    mpu6500ReadRegister((0x43), buf, 6);
