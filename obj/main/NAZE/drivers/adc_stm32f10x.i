...
# 47 "./src/main/drivers/adc_stm32f10x.c"
void adcInit(drv_adc_config_t *init)
{
    ...
    dma.DMA_PeripheralBaseAddr = (uint32_t)&((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->DR;
    ...
    dma.DMA_MemoryInc = configuredAdcChannels > 1 ? ((uint32_t)0x00000080) : ((uint32_t)0x00000000);
