...
# 5 "c:\\program files (x86)\\gnu tools arm embedded\\4.9 2014q4\\arm-none-eabi\\include\\ctype.h" 2 3
...
# 95 "./src/main/flight/navigation.c"
...
# 413 "./src/main/flight/navigation.c"
static void GPS_calc_longitude_scaling(int32_t lat)
{
...
# 478 "./src/main/flight/navigation.c"
static void GPS_calc_velocity(void)
{
...
# 512 "./src/main/flight/navigation.c"
static void GPS_calc_location_error(int32_t *target_lat, int32_t *target_lng, int32_t *gps_lat, int32_t *gps_lng)
{
...
# 605 "./src/main/flight/navigation.c"
static uint16_t GPS_calc_desired_speed(uint16_t max_speed, _Bool _slow)
{
