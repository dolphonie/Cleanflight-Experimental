...
static lowpass_t lowpassFilters[10];


static const motorMixer_t mixerQuadX[] = { { 1.0f, -1.0f, 1.0f, -1.0f },
  { 1.0f, -1.0f, -1.0f, 1.0f },
  { 1.0f, 1.0f, 1.0f, 1.0f },
  { 1.0f, 1.0f, -1.0f, -1.0f },
  };

static const motorMixer_t mixerTri[] = { { 1.0f, 0.0f, 1.333333f, 0.0f },
  { 1.0f, -1.0f, -0.666667f, 0.0f },
  { 1.0f, 1.0f, -0.666667f, 0.0f },
  };

static const motorMixer_t mixerQuadP[] = { { 1.0f, 0.0f, 1.0f, -1.0f },
  { 1.0f, -1.0f, 0.0f, 1.0f },
  { 1.0f, 1.0f, 0.0f, 1.0f },
  { 1.0f, 0.0f, -1.0f, -1.0f },
  };

static const motorMixer_t mixerBi[] = { { 1.0f, 1.0f, 0.0f, 0.0f },
  { 1.0f, -1.0f, 0.0f, 0.0f },
  };

static const motorMixer_t mixerY6[] = { { 1.0f, 0.0f, 1.333333f, 1.0f },
...
static const motorMixer_t mixerHex6P[] = { { 1.0f, -0.866025f, 0.5f, 1.0f },
...
static const motorMixer_t mixerY4[] = { { 1.0f, 0.0f, 1.0f, -1.0f },
  { 1.0f, -1.0f, -1.0f, 0.0f },
  { 1.0f, 0.0f, 1.0f, 1.0f },
  { 1.0f, 1.0f, -1.0f, 0.0f },
  };

static const motorMixer_t mixerHex6X[] = { { 1.0f, -0.5f, 0.866025f, 1.0f },
...
static const motorMixer_t mixerOctoX8[] = { { 1.0f, -1.0f, 1.0f, -1.0f },
  { 1.0f, -1.0f, -1.0f, 1.0f },
  { 1.0f, 1.0f, 1.0f, 1.0f },
  { 1.0f, 1.0f, -1.0f, -1.0f },
  { 1.0f, -1.0f, 1.0f, 1.0f },
...
static const motorMixer_t mixerOctoFlatX[] = { { 1.0f, 1.0f, -0.5f, 1.0f },
  { 1.0f, -0.5f, -1.0f, 1.0f },
  { 1.0f, -1.0f, 0.5f, 1.0f },
  { 1.0f, 0.5f, 1.0f, 1.0f },
  { 1.0f, 0.5f, -1.0f, -1.0f },
...
static const motorMixer_t mixerVtail4[] = { { 1.0f, 0.0f, 1.0f, 1.0f },
  { 1.0f, -1.0f, -1.0f, 0.0f },
  { 1.0f, 0.0f, 1.0f, -1.0f },
  { 1.0f, 1.0f, -1.0f, -0.0f },
  };

static const motorMixer_t mixerAtail4[] = { { 1.0f, 0.0f, 1.0f, 1.0f },
  { 1.0f, -1.0f, -1.0f, 0.0f },
  { 1.0f, 0.0f, 1.0f, -1.0f },
  { 1.0f, 1.0f, -1.0f, -0.0f },
  };

static const motorMixer_t mixerHex6H[] = { { 1.0f, -1.0f, 1.0f, -1.0f },
  { 1.0f, -1.0f, -1.0f, 1.0f },
  { 1.0f, 1.0f, 1.0f, 1.0f },
  { 1.0f, 1.0f, -1.0f, -1.0f },
  { 1.0f, 0.0f, 0.0f, 0.0f },
...
static const motorMixer_t mixerDualcopter[] = { { 1.0f, 0.0f, 0.0f, -1.0f },
  { 1.0f, 0.0f, 0.0f, 1.0f },
  };
...
int16_t determineServoMiddleOrForwardFromChannel(int nr) {
 ...
 if (channelToForwardFrom != (uint8_t)0xFF
...
static void forwardAuxChannelsToServos(void) {


 int8_t firstServo = servoCount - 4;


 uint8_t channelOffset = AUX1;

 int8_t servoOffset;
 for (servoOffset = 0; servoOffset < 4;
   servoOffset++) {
...
static void crazyMixer(void) {
 ...
 servo[3] = (-pitch + roll) / 2;
 servo[4] = (pitch + roll) / 2;
 servo[5] = (-yaw + roll) / 2;
 servo[6] = (yaw + roll) / 2;
...
void mixTable(void) {
 ...
 if (motorCount
   >= 4&& mixerConfig->yaw_jump_prevention_limit < 500) {

  axisPID[YAW] = constrain(axisPID[YAW],
    -mixerConfig->yaw_jump_prevention_limit - ((rcCommand[YAW]) > 0 ? (rcCommand[YAW]) : -(rcCommand[YAW])),
    mixerConfig->yaw_jump_prevention_limit + ((rcCommand[YAW]) > 0 ? (rcCommand[YAW]) : -(rcCommand[YAW])));
 }
 ...
 case MIXER_BI:
  servo[4] = (servoDirection(4, 2) * axisPID[YAW])
    ...
    + determineServoMiddleOrForwardFromChannel(4);
  servo[5] = (servoDirection(5, 2) * axisPID[YAW])
    + (servoDirection(5, 1) * axisPID[PITCH])
    + determineServoMiddleOrForwardFromChannel(5);
  break;
 ...
 case MIXER_GIMBAL:
  ...
  servo[1] = (((int32_t) servoConf[1].rate
    * inclination.values.rollDeciDegrees) / 50)
    + determineServoMiddleOrForwardFromChannel(1);
  break;
 ...
 case MIXER_DUALCOPTER:
  for (i = 4; i < 6; i++) {
   servo[i] = axisPID[5 - i] * servoDirection(i, 1);
   servo[i] += determineServoMiddleOrForwardFromChannel(i);
  }
  break;
 ...
 case MIXER_SINGLECOPTER:
  for (i = 3; i < 7; i++) {
   servo[i] = (axisPID[YAW] * servoDirection(i, 2))
     + (axisPID[(6 - i) >> 1] * servoDirection(i, 1));
   servo[i] += determineServoMiddleOrForwardFromChannel(i);
  }
...
void filterServos(void) {
 ...
 if (mixerConfig->servo_lowpass_enable) {
  for (servoIdx = 0; servoIdx < 10; servoIdx++) {
