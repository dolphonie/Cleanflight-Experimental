...
# 19 "./src/main/flight/autotune.c" 2
...
# 20 "./src/main/flight/autotune.c" 2
...
# 11 "c:\\program files (x86)\\gnu tools arm embedded\\4.9 2014q4\\arm-none-eabi\\include\\string.h" 2 3
...
# 12 "c:\\program files (x86)\\gnu tools arm embedded\\4.9 2014q4\\arm-none-eabi\\include\\string.h" 2 3
...
# 21 "./src/main/flight/autotune.c" 2
...
# 22 "./src/main/flight/autotune.c" 2
...
# 24 "./src/main/flight/autotune.c" 2
...
# 25 "./src/main/flight/autotune.c" 2
...
# 26 "./src/main/flight/autotune.c" 2
...
# 30 "./src/main/flight/autotune.c" 2
...
# 31 "./src/main/flight/autotune.c" 2
...
# 33 "./src/main/flight/autotune.c" 2
...
# 34 "./src/main/flight/autotune.c" 2
...
# 35 "./src/main/flight/autotune.c" 2
...
# 37 "./src/main/flight/autotune.c" 2
...
# 38 "./src/main/flight/autotune.c" 2
...
# 40 "./src/main/flight/autotune.c" 2
...
# 41 "./src/main/flight/autotune.c" 2
...
# 43 "./src/main/flight/autotune.c" 2
...
static autotunePhase_e nextPhase = PHASE_TUNE_ROLL;

static float targetAngle = 0;
static float targetAngleAtPeak;
static float firstPeakAngle, secondPeakAngle;
...
#define MULTIWII_P_MULTIPLIER 10.0f
#define MULTIWII_I_MULTIPLIER 1000.0f


_Bool isAutotuneIdle(void)
{
...
static void autotuneLogCycleStart()
{
    if (feature(FEATURE_BLACKBOX)) {
        ...
        eventData.p = pid.p * 10.0f;
        eventData.i = pid.i * 1000.0f;
        eventData.d = pid.d;
...
float autotune(angle_index_t angleIndex, const rollAndPitchInclination_t *inclination, float errorAngle)
{
    ...
    if (rising) {
        currentAngle = (inclination->raw[angleIndex] / 10.0f);
    } else {
    ...
    if (secondPeakAngle == 0) {
        ...
        if (currentAngle > firstPeakAngle) {
            ...
            switch (cycle) {
                case CYCLE_TUNE_I:
                    ...
                    overshot = currentAngle - targetAngle >= 2.0f / 2;
        ...
        _Bool timedOut = signedDiff >= 0L;


        if (timedOut || (oscillationAmplitude > 2.0f / 2 && currentAngle > secondPeakAngle)) {



            overshot = firstPeakAngle > targetAngleAtPeak;
            if (overshot) {
# 356 "./src/main/flight/autotune.c"
                pid.p *= 0.97f;
                pid.d *= 1.03f;
            ...
            pidProfile->P8[pidIndex] = pid.p * 10.0f;
            ...
            if (feature(FEATURE_BLACKBOX)) {
                ...
                eventData.flags = (overshot ? 1 : 0) | (timedOut ? 2 : 0);
                eventData.p = pidProfile->P8[pidIndex];
                eventData.i = pidProfile->I8[pidIndex];
                eventData.d = pidProfile->D8[pidIndex];
            ...
            if (cycle == CYCLE_TUNE_PD2) {
                ...
                pidProfile->I8[pidIndex] = pid.i * 1000.0f;
            } else {
    ...
    return targetAngle - (inclination->raw[angleIndex] / 10.0f);
}
...
void autotuneBeginNextPhase(pidProfile_t *pidProfileToTune)
{
    ...
    pid.p = pidProfile->P8[pidIndex] / 10.0f;
    pid.i = pidProfile->I8[pidIndex] / 1000.0f;

    pid.d = pidProfile->D8[pidIndex] * (1.0f / 1.2f);
...
void autotuneEndPhase(void)
{
    if (phase == PHASE_TUNE_ROLL || phase == PHASE_TUNE_PITCH) {
        ...
        pidProfile->D8[pidIndex] = (pid.d * 1.2f);

        pidProfile->P8[PIDYAW] = pidProfile->P8[PIDROLL] * 2.0f;
...
_Bool havePidsBeenUpdatedByAutotune(void)
{
