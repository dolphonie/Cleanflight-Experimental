...
_Bool l3g4200dDetect(gyro_t *gyro, uint16_t lpf);
...
_Bool mpu3050Detect(gyro_t *gyro, uint16_t lpf);
...
_Bool mpu6050AccDetect(const mpu6050Config_t *config,acc_t *acc);
_Bool mpu6050GyroDetect(const mpu6050Config_t *config, gyro_t *gyro, uint16_t lpf);
...
_Bool l3gd20Detect(gyro_t *gyro, uint16_t lpf);
...
_Bool mpu6000SpiGyroDetect(gyro_t *gyro, uint16_t lpf);
...
_Bool mpu6500SpiGyroDetect(gyro_t *gyro, uint16_t lpf);
...
# 120 "./src/main/sensors/initialisation.c"
    return ((void *)0);
}
# 157 "./src/main/sensors/initialisation.c"
_Bool detectGyro(uint16_t gyroLpf)
{
    ...
    switch(gyroHardware) {
        ...
        case GYRO_MPU6050:
            ...
            ;
        case GYRO_L3G4200D:
# 187 "./src/main/sensors/initialisation.c"
            ;
        ...
        case GYRO_L3GD20:
# 211 "./src/main/sensors/initialisation.c"
            ;
...
# 245 "./src/main/sensors/initialisation.c"
            ;
...
retry:
    ...
    switch (accHardwareToUse) {
        ...
        case ACC_ADXL345:
            ...
            ;
        case ACC_LSM303DLHC:
# 310 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6050:
...
# 359 "./src/main/sensors/initialisation.c"
            ;
...
# 523 "./src/main/sensors/initialisation.c"
retry:
    ...
    switch(magHardwareToUse) {
        ...
        case MAG_AK8975:
# 553 "./src/main/sensors/initialisation.c"
            ;
...
_Bool sensorsAutodetect(sensorAlignmentConfig_t *sensorAlignmentConfig, uint16_t gyroLpf, uint8_t accHardwareToUse, uint8_t magHardwareToUse, int16_t magDeclinationFromConfig)
{
    int16_t deg, min;
