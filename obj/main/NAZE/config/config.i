...
static void resetConf(void)
{
    ...
    int8_t servoRates[10] = { 30, 30, 100, 100, 100, 100, 100, 100, 100, 100 };
    ;
    ...
    masterConfig.rxConfig.rx_min_usec = 985;
    ...
    for (i = 0; i < 10; i++) {
        currentProfile->servoConf[i].min = 1020;
