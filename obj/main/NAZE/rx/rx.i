...
static _Bool shouldCheckPulse = 1;
...
static rcReadRawDataPtr rcReadRawFunc = ((void *)0);
...
static void rxCheckPulse(uint8_t channel, uint16_t pulseDuration)
{
...
void serialRxInit(rxConfig_t *rxConfig)
{
    ...
    if (!enabled) {
        ...
        rcReadRawFunc = ((void *)0);
    }
}

uint8_t serialRxFrameStatus(rxConfig_t *rxConfig)
{
# 184 "./src/main/rx/rx.c"
    switch (rxConfig->serialrx_provider) {
        case SERIALRX_SPEKTRUM1024:
        case SERIALRX_SPEKTRUM2048:
...
{
    static int16_t rcSamples[12][4];
    static int16_t rcDataMean[12];
    static _Bool rxSamplesCollected = 0;

    uint8_t currentSampleIndex = rcSampleIndex % 4;
...
static void processRxChannels(void)
{
    ...
    for (chan = 0; chan < rxRuntimeConfig.channelCount; chan++) {
        ...
        uint8_t rawChannel = calculateChannelRemapping(rxConfig->rcmap, (sizeof(((rxConfig_t *)0)->rcmap) / sizeof(((rxConfig_t *)0)->rcmap[0])), chan);
