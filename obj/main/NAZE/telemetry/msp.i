...
# 39 "./src/main/telemetry/msp.c" 2
# 1 "./src/main/telemetry/msp.h" 1
# 26 "./src/main/telemetry/msp.h"
...
# 40 "./src/main/telemetry/msp.c" 2

static telemetryConfig_t *telemetryConfig;
static serialPortConfig_t *portConfig;

static _Bool mspTelemetryEnabled = 0;
static portSharing_e mspPortSharing;

#define TELEMETRY_MSP_INITIAL_PORT_MODE MODE_TX

static serialPort_t *mspTelemetryPort = ((void *)0);
...
void checkMSPTelemetryState(void)
{
    _Bool newTelemetryEnabledValue = determineNewTelemetryEnabledState(mspPortSharing);
...
void freeMSPTelemetryPort(void)
{
    ...
    mspTelemetryPort = ((void *)0);
    mspTelemetryEnabled = 0;
}
...
void configureMSPTelemetryPort(void)
{
    ...
    mspTelemetryPort = openSerialPort(portConfig->identifier, FUNCTION_TELEMETRY_MSP, ((void *)0), baudRates[baudRateIndex], MODE_TX, SERIAL_NOT_INVERTED);
