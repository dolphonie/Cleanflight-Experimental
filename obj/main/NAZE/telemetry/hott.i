...
void hottPrepareGPSResponse(HOTT_GPS_MSG_t *hottGPSMessage)
{
    ...
    uint16_t hottGpsAltitude = (GPS_altitude / 10) + 500;
...
void checkHoTTTelemetryState(void)
{
    _Bool newTelemetryEnabledValue = determineNewTelemetryEnabledState(hottPortSharing);
