...
#define SMARTPORT_SERVICE_DELAY_MS 5
...
void checkSmartPortTelemetryState(void)
{
    _Bool newTelemetryEnabledValue = determineNewTelemetryEnabledState(smartPortPortSharing);
...
void handleSmartPortTelemetry(void)
{
    ...
    if ((now - smartPortLastServiceTime) < 5)
        return;
    ...
    if (smartPortHasRequest) {
        ...
        switch(id) {
            ...
            case FSSP_DATAID_CURRENT :
                smartPortSendPackage(id, amperage);
                smartPortHasRequest = 0;
                break;
            ...
            case FSSP_DATAID_HEADING :
                smartPortSendPackage(id, heading * 100);
                smartPortHasRequest = 0;
                break;
            ...
            case FSSP_DATAID_GPS_ALT :
                if (sensors(SENSOR_GPS) && (stateFlags & (GPS_FIX))) {
                    smartPortSendPackage(id, GPS_altitude * 1000);
                    smartPortHasRequest = 0;
                }
                break;
