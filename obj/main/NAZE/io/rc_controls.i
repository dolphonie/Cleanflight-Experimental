...
# 28 "./src/main/io/rc_controls.c" 2
...
void mwDisarm(void);
# 31 "./src/main/io/rc_controls.c" 2
...
# 34 "./src/main/io/rc_controls.c" 2
...
# 46 "./src/main/io/rc_controls.c" 2
...
void applyStepAdjustment(controlRateConfig_t *controlRateConfig, uint8_t adjustmentFunction, int delta) {
    ...
    switch(adjustmentFunction) {
        ...
        case ADJUSTMENT_ROLL_RATE:
            ...
            controlRateConfig->rates[FD_ROLL] = constrain(newValue, 0, 100);
            break;
        case ADJUSTMENT_YAW_RATE:
            newValue = (int)controlRateConfig->rates[FD_YAW] + delta;
            controlRateConfig->rates[FD_YAW] = constrain(newValue, 0, 255);
            break;
        case ADJUSTMENT_PITCH_ROLL_P:
        case ADJUSTMENT_PITCH_P:
            if ((pidProfile->pidController == 2)) {
                newFloatValue = pidProfile->P_f[PIDPITCH] + (float)(delta / 10.0f);
                pidProfile->P_f[PIDPITCH] = constrainf(newFloatValue, 0, 100);
            } else {
                newValue = (int)pidProfile->P8[PIDPITCH] + delta;
                pidProfile->P8[PIDPITCH] = constrain(newValue, 0, 200);
            }
        ...
        case ADJUSTMENT_ROLL_P:
            if ((pidProfile->pidController == 2)) {
                ...
                pidProfile->P_f[PIDROLL] = constrainf(newFloatValue, 0, 100);
            } else {
                newValue = (int)pidProfile->P8[PIDROLL] + delta;
                pidProfile->P8[PIDROLL] = constrain(newValue, 0, 200);
            }
            break;
        ...
        case ADJUSTMENT_PITCH_I:
            if ((pidProfile->pidController == 2)) {
                ...
                pidProfile->I_f[PIDPITCH] = constrainf(newFloatValue, 0, 100);
            } else {
                newValue = (int)pidProfile->I8[PIDPITCH] + delta;
                pidProfile->I8[PIDPITCH] = constrain(newValue, 0, 200);
            }
        ...
        case ADJUSTMENT_ROLL_I:
            if ((pidProfile->pidController == 2)) {
                ...
                pidProfile->I_f[PIDROLL] = constrainf(newFloatValue, 0, 100);
            } else {
                newValue = (int)pidProfile->I8[PIDROLL] + delta;
                pidProfile->I8[PIDROLL] = constrain(newValue, 0, 200);
            }
            break;
        ...
        case ADJUSTMENT_PITCH_D:
            if ((pidProfile->pidController == 2)) {
                ...
                pidProfile->D_f[PIDPITCH] = constrainf(newFloatValue, 0, 100);
            } else {
                newValue = (int)pidProfile->D8[PIDPITCH] + delta;
                pidProfile->D8[PIDPITCH] = constrain(newValue, 0, 200);
            }
        ...
        case ADJUSTMENT_ROLL_D:
            if ((pidProfile->pidController == 2)) {
                ...
                pidProfile->D_f[PIDROLL] = constrainf(newFloatValue, 0, 100);
            } else {
                newValue = (int)pidProfile->D8[PIDROLL] + delta;
                pidProfile->D8[PIDROLL] = constrain(newValue, 0, 200);
            }
            break;
        case ADJUSTMENT_YAW_P:
            if ((pidProfile->pidController == 2)) {
                newFloatValue = pidProfile->P_f[PIDYAW] + (float)(delta / 10.0f);
                pidProfile->P_f[PIDYAW] = constrainf(newFloatValue, 0, 100);
            } else {
                newValue = (int)pidProfile->P8[PIDYAW] + delta;
                pidProfile->P8[PIDYAW] = constrain(newValue, 0, 200);
            }
            break;
        case ADJUSTMENT_YAW_I:
            if ((pidProfile->pidController == 2)) {
                newFloatValue = pidProfile->I_f[PIDYAW] + (float)(delta / 100.0f);
                pidProfile->I_f[PIDYAW] = constrainf(newFloatValue, 0, 100);
            } else {
                newValue = (int)pidProfile->I8[PIDYAW] + delta;
                pidProfile->I8[PIDYAW] = constrain(newValue, 0, 200);
            }
            break;
        case ADJUSTMENT_YAW_D:
            if ((pidProfile->pidController == 2)) {
                newFloatValue = pidProfile->D_f[PIDYAW] + (float)(delta / 1000.0f);
                pidProfile->D_f[PIDYAW] = constrainf(newFloatValue, 0, 100);
            } else {
                newValue = (int)pidProfile->D8[PIDYAW] + delta;
                pidProfile->D8[PIDYAW] = constrain(newValue, 0, 200);
            }
            break;
        default:
            break;
